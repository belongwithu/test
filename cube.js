...
(function() {
    if (!requirejs.defined('abb7c/c2b23/a33aa'))
        return API.chatLog('This version of plug&#179; is not compatible with this version of plug.dj', true), false;

    define('plugCubed/Model', ['jquery', 'underscore', 'abb7c/c2b23/a33aa', 'abb7c/c2b23/adf95', 'abb7c/ac6a9/a6bdd', 'abb7c/f7d84/d69ba', 'abb7c/cc6c7/ba717', 'abb7c/a0cda/e6b37', 'abb7c/fb03c/dc2a5', 'abb7c/e4d79/db26e', 'abb7c/e4d79/b266f', 'abb7c/a0cda/e81a0', 'lang/Lang', 'abb7c/ef7e0/c297f/b5951', 'abb7c/fb03c/d53b9', 'abb7c/fb03c/a6e3b', 'plugCubed/StyleManager', 'abb7c/ef7e0/c297f/b7b17/d216f', 'abb7c/ef7e0/c297f/b7b17/a59c6', 'plugCubed/RoomUserListRow', 'plugCubed/Lang', 'plugCubed/Utils', 'abb7c/f7d84/ba0e4', 'abb7c/a0cda/a3d1e', 'plugCubed/dialogs/Commands', 'plugCubed/Slider', 'plugCubed/VolumeView'], function($, _, Class, Context, Chat, LocalStorage, Utils, Room, MCE, Socket, SIO, TUM, Lang, Audience, RJE, RSE, Styles, RoomUserListView, RoomUserListRow, _RoomUserListRow, p3Lang, p3Utils, MediaCollection, PlaybackModel, dialogCommands, Slider, VolumeView) {
            ...
            if (settings !== undefined) {
                ...
                if (settings.rules !== undefined) {
                    ...
                    if (settings.rules.allowAutojoin !== undefined)
                        roomRules.allowAutojoin = settings.rules.allowAutojoin === 'true';
        ...
        return Class.extend({
            ...
            close: function() {
                ...
                if (socket) {
                    socket.onclose = function() {
                        console.log('[plugยณ Socket Server]', 'Closed');
                    };
                    socket.close();
                }
            ...
            Socket: function() {
                ...
                socket.tries = 0;
                console.log('[plugยณ Socket Server]', socketReconnecting ? 'Reconnecting' : 'Connecting');
                /**
                 * @this {SockJS}
                 */
                socket.onopen = function() {
                    this.tries = 0;
                    console.log('[plugยณ Socket Server]', socketReconnecting ? 'Reconnected' : 'Connected');
    ...
    define('plugCubed/dialogs/Settings', ['underscore', 'abb7c/f7d84/d69ba', 'plugCubed/Lang', 'abb7c/fb03c/f3a3f', 'abb7c/fb03c/af1aa', 'abb7c/ac6a9/a6bdd', 'abb7c/a0cda/e81a0', 'abb7c/a0cda/b767b', 'abb7c/cae4d/b7b17/ffe8d', 'abb7c/cc6c7/ba717', 'abb7c/ef7e0/a3ee0/cfffd', 'abb7c/ef7e0/a62b5/f5d31', 'lang/Lang'], function(_, LocalStorage, p3Lang, t, n, r, i, s, o, u, a, f, l) {
        var langauges,
            c = a.extend({
    ...
    define('plugCubed/dialogs/CustomChatColors', ['jquery', 'abb7c/c2b23/a33aa', 'lang/Lang', 'abb7c/c2b23/adf95', 'plugCubed/Lang'], function($, b, c, d, p3Lang) {
    ...
    define('plugCubed/dialogs/Userinfo', ['jquery', 'abb7c/ef7e0/a3ee0/cfffd', 'lang/Lang', 'abb7c/c2b23/a33aa', 'abb7c/c2b23/adf95', 'abb7c/fb03c/f7cc5', 'plugCubed/Lang'], function($, b, c, d, e, f, p3Lang) {
        var a = d.extend({
            init: function(id) {
    ...
    define('plugCubed/dialogs/Commands', ['jquery', 'abb7c/c2b23/a33aa', 'lang/Lang', 'plugCubed/Lang', 'plugCubed/Utils'], function($, b, c, p3Lang, p3Utils) {
        var userCommands = [
    ...
    define('plugCubed/StyleManager', ['jquery', 'abb7c/c2b23/a33aa'], function($, Class) {
        var obj,
            styles = {},
            update = function() {
                var a = '';
    ...
    define('plugCubed/Utils', ['abb7c/ef7e0/c297f/c7b6c/c0c63'], function(PopoutView) {
    ...
    define('plugCubed/RoomUserListRow', ['jquery', 'abb7c/ef7e0/c297f/b7b17/d176c', 'plugCubed/Utils'], function($, RoomUserListRow, p3Utils) {
    ...
    define('plugCubed/Lang', ['jquery', 'abb7c/c2b23/a33aa'], function($, Class) {
        var language = {},
            isLoaded = false,
            Lang = Class.extend({
                init: function() {
    ...
    define('plugCubed/Slider', ['jquery', 'abb7c/c2b23/a33aa'], function($, Class) {
        return Class.extend({
    ...
    define('plugCubed/Loader', ['jquery', 'abb7c/c2b23/a33aa', 'plugCubed/Model', 'abb7c/f7d84/d69ba', 'abb7c/ef7e0/a3ee0/cfffd', 'plugCubed/Lang', 'plugCubed/Utils'], function($, Class, Model, LocalStorage, ADV, p3Lang, p3Utils) {
    ...
    */
    define('plugCubed/VolumeView', ['jquery', 'underscore', 'abb7c/ef7e0/c297f/c133e/fa3aa', 'abb7c/a0cda/a3d1e', 'hbs!template/room/playback/Volume', 'abb7c/c2b23/adf95', 'plugCubed/Lang'], function($, e, original, r, s, Context, p3Lang) {
